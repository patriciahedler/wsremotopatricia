...
public class TesteTipos {
 public static void main(String[] args) {
	...
	System.out.printf("O valor unitário considerando o imposto é %.2f;", valorcomimposto);
	System.out.printf("O valor de imposto por unidade é %.2f;", valorimposto);
	System.out.printf("O valor total da compra é %.2f;", valortotalimp);
	System.out.printf("O valor total da compra sem imposto é %.2f", valortotsemimp);
